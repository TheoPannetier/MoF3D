 ...
 <registry>
  <ref name="project">
   <ref name="objects">
    ...
    <ref name="meta">
     <de.grogra.pf.registry.NodeReference name="Forest" ref="842347381"/>
    </ref>
    <ref name="3d">
     <ref name="shaders">
   ...
   <ref name="state">
    <de.grogra.pf.ui.registry.Layout name="layout">
     <de.grogra.pf.ui.registry.MainWindow>
      <de.grogra.pf.ui.registry.Split location="0.53112584">
       <de.grogra.pf.ui.registry.Split location="0.63709676" orientation="0">
        <de.grogra.pf.ui.registry.Split orientation="0">
         ...
         <de.grogra.pf.ui.registry.PanelFactory source="/ui/panels/3d/defaultview">
          ...
          <de.grogra.pf.registry.Option name="view" type="de.grogra.imp3d.View3D" value="graphDescriptor=[de.grogra.imp.ProjectGraphDescriptor]visibleScales={false false false true false}visibleLayers={true true true true true true true true true true true true true true true true}epsilon=1.0E-6 visualEpsilon=0.01 magnitude=1.0 camera=(minZ=0.1 maxZ=2000.0 projection=[de.grogra.imp3d.PerspectiveProjection aspect=1.0 fieldOfView=1.0471976]transformation=(0.33137876605674405 -0.9434978078408587 0.0 20.384917603137403 -0.2923523503502971 -0.10268106646121329 0.9507821526635497 -23.408960495450106 -0.8970608767727353 -0.31506901653864317 -0.3098601267752447 -60.19396437699876 0.0 0.0 0.0 1.0))eventFactory=[de.grogra.imp3d.DefaultView3DEventFactory]"/>
       ...
       <de.grogra.pf.ui.registry.Split location="0.5752688" orientation="0">
        <de.grogra.pf.ui.registry.Tab selectedIndex="0">
         <de.grogra.pf.ui.registry.PanelFactory source="/ui/panels/texteditor">
          <de.grogra.pf.registry.Option name="documents" type="java.lang.String" value="&quot;\&quot;pfs:Forest.rgg\&quot;&quot;"/>
