       ...
       <de.grogra.pf.ui.registry.Split location="0.79812694" orientation="0">
        <de.grogra.pf.ui.registry.Split orientation="0">
         ...
         <de.grogra.pf.ui.registry.PanelFactory source="/ui/panels/3d/defaultview">
          ...
          <de.grogra.pf.registry.Option name="view" type="de.grogra.imp3d.View3D" value="graphDescriptor=[de.grogra.imp.ProjectGraphDescriptor]visibleScales={false false false true false}visibleLayers={true true true true true true true true true true true true true true true true}epsilon=1.0E-6 visualEpsilon=0.01 magnitude=1.0 camera=(minZ=0.1 maxZ=2000.0 projection=[de.grogra.imp3d.PerspectiveProjection aspect=1.0 fieldOfView=1.0471976]transformation=(0.33137876605674405 -0.9434978078408587 0.0 13.632917754056374 -0.2923523503502971 -0.10268106646121329 0.9507821526635497 -8.13196083691771 -0.8970608767727353 -0.31506901653864317 -0.3098601267752447 0.14509119094257272 0.0 0.0 0.0 1.0))eventFactory=[de.grogra.imp3d.DefaultView3DEventFactory]"/>
